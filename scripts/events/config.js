...
hexo.extend.filter.register('before_generate', () => {
  ...
  const internalSrcCDN = {
    ...
    main: `https://jsdelivr.pai233.top/npm/hexo-theme-butterfly@${version}/source/js/main.min.js`,
    utils: `https://jsdelivr.pai233.top/npm/hexo-theme-butterfly@${version}/source/js/utils.min.js`,
    translate: `https://jsdelivr.pai233.top/npm/hexo-theme-butterfly@${version}/source/js/tw_cn.min.js`,
    local_search: `https://jsdelivr.pai233.top/npm/hexo-theme-butterfly@${version}/source/js/search/local-search.min.js`,
    algolia_js: `https://jsdelivr.pai233.top/npm/hexo-theme-butterfly@${version}/source/js/search/algolia.min.js`,
  }
  ...
  const thirdPartySrcCDN = {
    ...
    twikoo: 'https://jsdelivr.pai233.top/npm/twikoo@1/dist/twikoo.all.min.js',
    waline_js: 'https://jsdelivr.pai233.top/npm/@waline/client/dist/waline.js',
    waline_css: 'https://jsdelivr.pai233.top/npm/@waline/client/dist/waline.css',
    sharejs: 'https://jsdelivr.pai233.top/gh/overtrue/share.js@master/dist/js/social-share.min.js',
    ...
    instantpage: 'https://jsdelivr.pai233.top/npm/instant.page@5/instantpage.min.js',
    typed: 'https://jsdelivr.pai233.top/npm/typed.js/lib/typed.min.js',
    pangu: 'https://jsdelivr.pai233.top/npm/pangu@4/dist/browser/pangu.min.js',
    ...
    aplayer_css: 'https://jsdelivr.pai233.top/npm/aplayer@1/dist/APlayer.min.css',
    aplayer_js: 'https://jsdelivr.pai233.top/npm/aplayer@1/dist/APlayer.min.js',
    meting_js: 'https://jsdelivr.pai233.top/gh/metowolf/MetingJS@1.2/dist/Meting.min.js',
    prismjs_js: 'https://jsdelivr.pai233.top/npm/prismjs@1/prism.min.js',
    prismjs_lineNumber_js: 'https://jsdelivr.pai233.top/npm/prismjs@1/plugins/line-numbers/prism-line-numbers.min.js',
    prismjs_autoloader: 'https://jsdelivr.pai233.top/npm/prismjs@1/plugins/autoloader/prism-autoloader.min.js',
  }
